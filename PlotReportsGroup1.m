...
%% File paths
topDir = '\\root\programs\Light-and-Health\IAI_CircadianMonitoringAndRegulation\CMR2-Exp1-Data\Group_1';
...
calibrationArray = readCalibration(deviceFiles{iSub});
...
% Fill in gaps
lightReading = LRCgapFillLightReading(lightReading);
