function newLightReading = LRCgapFillLightReading(lightReading, subject, startTime)
...
newLightReading.timeUTC = (startTime:expectedInc:max(lightReading.timeUTC))'; % Original method
