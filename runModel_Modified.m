function dlmoCollector = runModel_Modified
...
for iSub = 1:nSub
    ...
    [dlmoCollector.acrophase_10day_baseline(iSub),dlmoCollector.acrophase_DLMO_baseline(iSub)] = tenDayAcrophase(activityReading, appDT(1));
    ...
    [dlmoCollector.acrophase_10day_intervention(iSub),dlmoCollector.acrophase_DLMO_intervention(iSub)] = tenDayAcrophase(activityReading, appDT(end));
